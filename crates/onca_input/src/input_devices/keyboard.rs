...
impl Keyboard {
    ...
    pub const ANY             : InputAxisId = InputAxisId::const_new(keycode_name::ANY            );
    pub const SHIFT           : InputAxisId = InputAxisId::const_new(keycode_name::SHIFT          );
    pub const LSHIFT          : InputAxisId = InputAxisId::const_new(keycode_name::LSHIFT         );
    pub const RSHIFT          : InputAxisId = InputAxisId::const_new(keycode_name::RSHIFT         );
    pub const CTRL            : InputAxisId = InputAxisId::const_new(keycode_name::CTRL           );
    pub const LCTR            : InputAxisId = InputAxisId::const_new(keycode_name::LCTR           );
    pub const RCTR            : InputAxisId = InputAxisId::const_new(keycode_name::RCTR           );
    pub const ALT             : InputAxisId = InputAxisId::const_new(keycode_name::ALT            );
    pub const LALT            : InputAxisId = InputAxisId::const_new(keycode_name::LALT           );
    pub const RALT            : InputAxisId = InputAxisId::const_new(keycode_name::RALT           );
    pub const LCOMMAND        : InputAxisId = InputAxisId::const_new(keycode_name::LCOMMAND       );
    pub const RCOMMAND        : InputAxisId = InputAxisId::const_new(keycode_name::RCOMMAND       );
    pub const MENU            : InputAxisId = InputAxisId::const_new(keycode_name::MENU           );
    pub const SPACE           : InputAxisId = InputAxisId::const_new(keycode_name::SPACE          );
    pub const BACKSPACE       : InputAxisId = InputAxisId::const_new(keycode_name::BACKSPACE      );
    pub const TAB             : InputAxisId = InputAxisId::const_new(keycode_name::TAB            );
    pub const ENTER           : InputAxisId = InputAxisId::const_new(keycode_name::ENTER          );
    pub const ESCAPE          : InputAxisId = InputAxisId::const_new(keycode_name::ESCAPE         );
    pub const DELETE          : InputAxisId = InputAxisId::const_new(keycode_name::DELETE         );
    pub const INSERT          : InputAxisId = InputAxisId::const_new(keycode_name::INSERT         );
    pub const HOME            : InputAxisId = InputAxisId::const_new(keycode_name::HOME           );
    pub const END             : InputAxisId = InputAxisId::const_new(keycode_name::END            );
    pub const PG_DOWN         : InputAxisId = InputAxisId::const_new(keycode_name::PG_DOWN        );
    pub const PG_UP           : InputAxisId = InputAxisId::const_new(keycode_name::PG_UP          );
    pub const PRINT_SCREEN    : InputAxisId = InputAxisId::const_new(keycode_name::PRINT_SCREEN   );
    pub const CAPS_LOCK       : InputAxisId = InputAxisId::const_new(keycode_name::CAPS_LOCK      );
    pub const NUM_LOCK        : InputAxisId = InputAxisId::const_new(keycode_name::NUM_LOCK       );
    pub const SCROLL_LOCK     : InputAxisId = InputAxisId::const_new(keycode_name::SCROLL_LOCK    );
    pub const UP              : InputAxisId = InputAxisId::const_new(keycode_name::UP             );
    pub const DOWN            : InputAxisId = InputAxisId::const_new(keycode_name::DOWN           );
    pub const LEFT            : InputAxisId = InputAxisId::const_new(keycode_name::LEFT           );
    pub const RIGHT           : InputAxisId = InputAxisId::const_new(keycode_name::RIGHT          );
    pub const BREAK           : InputAxisId = InputAxisId::const_new(keycode_name::BREAK          );
    pub const CLEAR           : InputAxisId = InputAxisId::const_new(keycode_name::CLEAR          );
    pub const F1              : InputAxisId = InputAxisId::const_new(keycode_name::F1             );
    pub const F2              : InputAxisId = InputAxisId::const_new(keycode_name::F2             );
    pub const F3              : InputAxisId = InputAxisId::const_new(keycode_name::F3             );
    pub const F4              : InputAxisId = InputAxisId::const_new(keycode_name::F4             );
    pub const F5              : InputAxisId = InputAxisId::const_new(keycode_name::F5             );
    pub const F6              : InputAxisId = InputAxisId::const_new(keycode_name::F6             );
    pub const F7              : InputAxisId = InputAxisId::const_new(keycode_name::F7             );
    pub const F8              : InputAxisId = InputAxisId::const_new(keycode_name::F8             );
    pub const F9              : InputAxisId = InputAxisId::const_new(keycode_name::F9             );
    pub const F10             : InputAxisId = InputAxisId::const_new(keycode_name::F10            );
    pub const F11             : InputAxisId = InputAxisId::const_new(keycode_name::F11            );
    pub const F12             : InputAxisId = InputAxisId::const_new(keycode_name::F12            );
    pub const NUMPAD0         : InputAxisId = InputAxisId::const_new(keycode_name::NUMPAD0        );
    pub const NUMPAD1         : InputAxisId = InputAxisId::const_new(keycode_name::NUMPAD1        );
    pub const NUMPAD2         : InputAxisId = InputAxisId::const_new(keycode_name::NUMPAD2        );
    pub const NUMPAD3         : InputAxisId = InputAxisId::const_new(keycode_name::NUMPAD3        );
    pub const NUMPAD4         : InputAxisId = InputAxisId::const_new(keycode_name::NUMPAD4        );
    pub const NUMPAD5         : InputAxisId = InputAxisId::const_new(keycode_name::NUMPAD5        );
    pub const NUMPAD6         : InputAxisId = InputAxisId::const_new(keycode_name::NUMPAD6        );
    pub const NUMPAD7         : InputAxisId = InputAxisId::const_new(keycode_name::NUMPAD7        );
    pub const NUMPAD8         : InputAxisId = InputAxisId::const_new(keycode_name::NUMPAD8        );
    pub const NUMPAD9         : InputAxisId = InputAxisId::const_new(keycode_name::NUMPAD9        );
    pub const NUMPAD_MULTIPY  : InputAxisId = InputAxisId::const_new(keycode_name::NUMPAD_MULTIPY );
    pub const NUMPAD_ADD      : InputAxisId = InputAxisId::const_new(keycode_name::NUMPAD_ADD     );
    pub const NUMPAD_SUBTRACT : InputAxisId = InputAxisId::const_new(keycode_name::NUMPAD_SUBTRACT);
    pub const NUMPAD_DECIMAL  : InputAxisId = InputAxisId::const_new(keycode_name::NUMPAD_DECIMAL );
    pub const NUMPAD_DIVIDE   : InputAxisId = InputAxisId::const_new(keycode_name::NUMPAD_DIVIDE  );
    pub const A               : InputAxisId = InputAxisId::const_new(keycode_name::A              );
    pub const B               : InputAxisId = InputAxisId::const_new(keycode_name::B              );
    pub const C               : InputAxisId = InputAxisId::const_new(keycode_name::C              );
    pub const D               : InputAxisId = InputAxisId::const_new(keycode_name::D              );
    pub const E               : InputAxisId = InputAxisId::const_new(keycode_name::E              );
    pub const F               : InputAxisId = InputAxisId::const_new(keycode_name::F              );
    pub const G               : InputAxisId = InputAxisId::const_new(keycode_name::G              );
    pub const H               : InputAxisId = InputAxisId::const_new(keycode_name::H              );
    pub const I               : InputAxisId = InputAxisId::const_new(keycode_name::I              );
    pub const J               : InputAxisId = InputAxisId::const_new(keycode_name::J              );
    pub const K               : InputAxisId = InputAxisId::const_new(keycode_name::K              );
    pub const L               : InputAxisId = InputAxisId::const_new(keycode_name::L              );
    pub const M               : InputAxisId = InputAxisId::const_new(keycode_name::M              );
    pub const N               : InputAxisId = InputAxisId::const_new(keycode_name::N              );
    pub const O               : InputAxisId = InputAxisId::const_new(keycode_name::O              );
    pub const P               : InputAxisId = InputAxisId::const_new(keycode_name::P              );
    pub const Q               : InputAxisId = InputAxisId::const_new(keycode_name::Q              );
    pub const R               : InputAxisId = InputAxisId::const_new(keycode_name::R              );
    pub const S               : InputAxisId = InputAxisId::const_new(keycode_name::S              );
    pub const T               : InputAxisId = InputAxisId::const_new(keycode_name::T              );
    pub const U               : InputAxisId = InputAxisId::const_new(keycode_name::U              );
    pub const V               : InputAxisId = InputAxisId::const_new(keycode_name::V              );
    pub const W               : InputAxisId = InputAxisId::const_new(keycode_name::W              );
    pub const X               : InputAxisId = InputAxisId::const_new(keycode_name::X              );
    pub const Y               : InputAxisId = InputAxisId::const_new(keycode_name::Y              );
    pub const Z               : InputAxisId = InputAxisId::const_new(keycode_name::Z              );
    pub const N0              : InputAxisId = InputAxisId::const_new(keycode_name::N0             );
    pub const N1              : InputAxisId = InputAxisId::const_new(keycode_name::N1             );
    pub const N2              : InputAxisId = InputAxisId::const_new(keycode_name::N2             );
    pub const N3              : InputAxisId = InputAxisId::const_new(keycode_name::N3             );
    pub const N4              : InputAxisId = InputAxisId::const_new(keycode_name::N4             );
    pub const N5              : InputAxisId = InputAxisId::const_new(keycode_name::N5             );
    pub const N6              : InputAxisId = InputAxisId::const_new(keycode_name::N6             );
    pub const N7              : InputAxisId = InputAxisId::const_new(keycode_name::N7             );
    pub const N8              : InputAxisId = InputAxisId::const_new(keycode_name::N8             );
    pub const N9              : InputAxisId = InputAxisId::const_new(keycode_name::N9             );
    pub const SEMICOLON       : InputAxisId = InputAxisId::const_new(keycode_name::SEMICOLON      );
    pub const EQUALS          : InputAxisId = InputAxisId::const_new(keycode_name::EQUALS         );
    pub const COMMA           : InputAxisId = InputAxisId::const_new(keycode_name::COMMA          );
    pub const HYPHEN          : InputAxisId = InputAxisId::const_new(keycode_name::HYPHEN         );
    pub const UNDERSCORE      : InputAxisId = InputAxisId::const_new(keycode_name::UNDERSCORE     );
    pub const PERIOD          : InputAxisId = InputAxisId::const_new(keycode_name::PERIOD         );
    pub const SLASH           : InputAxisId = InputAxisId::const_new(keycode_name::SLASH          );
    pub const BACKTICK        : InputAxisId = InputAxisId::const_new(keycode_name::BACKTICK       );
    pub const LBRACKET        : InputAxisId = InputAxisId::const_new(keycode_name::LBRACKET       );
    pub const RBRACKET        : InputAxisId = InputAxisId::const_new(keycode_name::RBRACKET       );
    pub const BACKSLASH       : InputAxisId = InputAxisId::const_new(keycode_name::BACKSLASH      );
    pub const APOSTROPHE      : InputAxisId = InputAxisId::const_new(keycode_name::APOSTROPHE     );
    pub const QUOTE           : InputAxisId = InputAxisId::const_new(keycode_name::QUOTE          );
    pub const LPAREN          : InputAxisId = InputAxisId::const_new(keycode_name::LPAREN         );
    pub const RPAREN          : InputAxisId = InputAxisId::const_new(keycode_name::RPAREN         );
    pub const AMPERSAND       : InputAxisId = InputAxisId::const_new(keycode_name::AMPERSAND      );
    pub const ASTERISK        : InputAxisId = InputAxisId::const_new(keycode_name::ASTERISK       );
    pub const CARET           : InputAxisId = InputAxisId::const_new(keycode_name::CARET          );
    pub const DOLLAR          : InputAxisId = InputAxisId::const_new(keycode_name::DOLLAR         );
    pub const EXCLAMATION     : InputAxisId = InputAxisId::const_new(keycode_name::EXCLAMATION    );
    pub const COLON           : InputAxisId = InputAxisId::const_new(keycode_name::COLON          );
    pub const EACUTE          : InputAxisId = InputAxisId::const_new(keycode_name::EACUTE         );
    pub const EGRAVE          : InputAxisId = InputAxisId::const_new(keycode_name::EGRAVE         );
    pub const AGRAVE          : InputAxisId = InputAxisId::const_new(keycode_name::AGRAVE         );
    pub const CCEDILLA        : InputAxisId = InputAxisId::const_new(keycode_name::CCEDILLA       );
    pub const SECTION         : InputAxisId = InputAxisId::const_new(keycode_name::SECTION        );
