...
impl_signed!{
    i64, 2, 4, 8,
    u64, i64,
    _mm_cmpeq_epi64, _mm_cmpgt_epi64, _mm_set1_epi64x, max_i64, min_i64
}
...
impl_unsigned!{
    u64, 2, 4, 8,
    u64, i64,
    _mm_cmpeq_epi64, _mm_cmpgt_epi64, _mm_set1_epi64x, max_u64, min_u64
}
...
#[inline(always)]
unsafe fn max_u64(a: __m128i, b: __m128i) -> __m128i {
...
#[inline(always)]
unsafe fn min_u64(a: __m128i, b: __m128i) -> __m128i {
    let sign_mask = _mm_set1_epi64x(i64::MIN);
    let imm_a = _mm_xor_si128(a, sign_mask);
    let imm_b = _mm_xor_si128(b, sign_mask);
